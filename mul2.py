...
def generateQuestion():
    ...
    item = ['Pen', 'Book', 'Box', 'Chocolate', 'Biscuit', 'Press', 'Mango', 'Banana', 'Doll', 'Flower', 'Bread', 'Watch', 'apple', 'apricot', 'avocado', 'banana', 'blackcurrant', 'blackberry', 'blueberry', 'cherry', 'coconut', 'fig', 'toy', 'kiwi', 'lemon', 'lime', 'lychee', 'mango', 'nectarine', 'orange', 'papaya', 'peach', 'pear', 'pineapple', 'plum', 'quince', 'raspberry', 'strawberry', 'watermelon']
    z = (random.choice(item))
    multiplication = ['buy', 'pay for', 'acquire', 'obtain', 'pick up', 'snap up', 'take', 'procure', 'invest', 'get hold of']
    ...
    str1 = "John purchase 9 bags of apple . how many apple in each bag? If total 45 apple John  purchase."
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.str3 = "John purchase 9 bags of apples. how many apples in each bag? If total 45 apples John  purchase."
        self.t = t
        #var.set("Equation Form Of The Mathword Problem Is:\n"+str(self.t[0]) +" * ? = "+ str(self.t[1]))
        self.k=divmod(self.t[1],self.t[0])
    ...
    def create_window(self):
        self.counter += 1
        t = tk.Toplevel(self)
        l = tk.Label(t, font=('arial', 25, 'bold'), bd=16,bg="#01b9f5", fg="#012b74", text="Correct Answer is->"+"\n Quotient is: "+str(self.k[0]) +"\n Remainder is: "+str(self.k[1]))
