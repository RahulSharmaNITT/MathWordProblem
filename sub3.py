...
def generateQuestion():
    ...
    subtraction = ['deducted', 'detracted', 'decreased by', 'difference', 'left', 'left over', 'less than', 'minus', 'reduced', 'remains', 'removed','subtracted', 'take away']
    az1 = (random.choice(subtraction))
    __title__ = 'names'
    __version__ = '0.2'
    ...
    p1 = random.randint(2, 199)
    p2 = random.randint(10, 199)
    f1 = max(p1,p2)
    f2 = min(p1,p2)
    q = str(f1)
    x = str(f2)
    ...
    str1 = "John had 5 Marbels. Jim took 2 from him. Now How many Marbels John have left?"
