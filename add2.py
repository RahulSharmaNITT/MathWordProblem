...
def generateQuestion():
    ...
    item = ['Beg', 'Pen', 'Book', 'Box', 'Chocolate', 'Biscuit', 'seashells','Car', 'Press', 'Mango', 'Banana', 'Doll', 'Flower', 'Bread', 'Watch', 'apple', 'apricot', 'avocado', 'banana', 'blackcurrant', 'blackberry', 'blueberry', 'cherry', 'coconut', 'fig', 'toy', 'kiwi', 'lemon', 'lime', 'lychee', 'mango', 'nectarine', 'orange', 'papaya', 'peach', 'pear', 'pineapple', 'plum', 'quince', 'raspberry', 'strawberry', 'watermelon']
    z = (random.choice(item))
    addition = ['present', 'provide', 'supply', 'furnish', 'gift', 'offer', 'proffer', 'award', 'grant', 'bestow', 'accord', 'confer', 'donate', 'contribute', 'give']
    ...
    p1 = random.randint(1, 40)
    p2 = random.randint(41, 200)
    q = str(p1)
    x = str(p2)
    ...
    str1 = "John had 5 marbles. Jim offered him some more. Now John has 8 marbles. How many did Jim offer him?"
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.str3 = "John had 5 marbles. Jim offered him some more. Now John has 8 marbles. How many did Jim offer him?"
        self.t = t
