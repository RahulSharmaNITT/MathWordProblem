...
def generateQuestion():
    ...
    addition = ['add', 'all together', 'altogether', 'combined', 'all', 'how much', 'in all', 'increased by', 'to plus', 'to sum', 'together', 'total', 'join']
    ...
    p1 = random.randint(1, 200)
    p2 = random.randint(1, 200)
    q = str(p1)
    x = str(p2)
    ...
    str1 = "John has 5 Marbles. Jim gave him 8 more. How many Marbles does John have altogether?"
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.str3 = "John has 5 Marbles. Jim gave him 8 more. How many Marbles does John have altogether?"
        self.t = t
