...
def generateQuestion():
    ...
    item = ['Beg', 'Pen', 'Book', 'Box', 'Chocolate', 'Biscuit', 'Car', 'Press', 'Mango', 'Banana', 'Doll', 'Flower', 'Bread', 'Watch', 'apple', 'apricot', 'avocado', 'banana', 'blackcurrant', 'blackberry', 'blueberry', 'cherry', 'coconut', 'fig', 'toy', 'kiwi(fruit)', 'lemon', 'lime', 'lychee', 'mango', 'nectarine', 'orange', 'papaya', 'peach', 'pear', 'pineapple', 'plum', 'quince', 'raspberry', 'strawberry', 'watermelon']
    ...
    str1 = "John had some marbles. Jim gave him 3 more. Now John has 8 marbles. How many marbles did John have to begin with?"
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.str3 = "John had some marbles. Jim gave him 3 more. Now John has 8 marbles. How many marbles did John have to begin with?"
        self.t = t
