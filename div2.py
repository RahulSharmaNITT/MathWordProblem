...
def generateQuestion():
    ...
    division = ['split', 'share', 'distribute', 'impart', 'dispense', 'halve', 'sunder', 'diverge', 'divide']
    az1 = (random.choice(division))
    ...
    p1 = random.randint(41, 400)
    p2 = random.randint(2, 40)
    q = str(p1)
    x = str(p2)
    ...
    str1 = "John had 63 apples. He divides all apples evenly among some friends. How many friends were there, If each of his friend get 7 apples?"
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.str3 = "John had 63 apples. He divides all apples evenly among some friends. How many friends were there, If each of his friend get 7 apples.?"
        self.t = t
        #var.set("Equation Form Of The Mathword Problem Is:\n"+str(self.t[0]) +" ÷ ? = "+ str(self.t[1]),relief=RAISED)
        self.k=divmod(self.t[0], self.t[1])
...
def OnGenQuest():
    ...
    for i in range(0,3000):
        ...
        doc.add_paragraph('Equation : ' + '" X = '+ str(t[0]) + ' / ' + str(t[1]) + '"')
        doc.add_paragraph('Answer : "' +  str(t[0] / t[1]) + '" \n}')
    doc.save('dataSetDiv2.docx')
