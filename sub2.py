...
def generateQuestion():
    ...
    subtration = ['lay hold of', 'take hold of', 'get hold of', 'grasped', 'gripped', 'clasped', 'clutched', 'grabbed']
    ...
    str1 = "John had 8 Marbels. Jim took some Marbels. Now John has 5  Marbels. How many did Jim tooks?"
